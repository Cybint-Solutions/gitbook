...
* Fixed an issue with [SMTP servers](../application-reference/settings/common-system-settings/smtp-servers.md) when OAuth is used as the authentication method.
