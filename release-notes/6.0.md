...
{% hint style="danger" %}
Upgrading from Lucy 5.7.6 to Lucy 6.0 requires a server migration for **on-premise deployments**. If you are running Lucy on-premise, please follow the [migration guide](../guides/installing-lucy/upgrading-to-lucy-6.0/) before upgrading.
{% endhint %}
