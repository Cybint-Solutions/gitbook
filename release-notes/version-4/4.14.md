...
3\) [Storage management improvements, that allows you to manually or automatically, archive and store campaigns in order to save storage space, without affecting collected statistics.](../../application-reference/settings/advanced-system-settings/advanced-settings.md#smart-storage)

4\) [Set a scheduled server update, in order to get the latest version without interrupting your daily routine.](../../application-reference/support/update.md)

5\) Get relaxed and set your server to automatically get security patches and hotfixes. In addition, while it is not recommended, there is an option to [Opt-out](../../application-reference/settings/advanced-system-settings/advanced-settings.md#auto-updates) security updates.

6\) Campaign schedule plan updates:

* [Take a break and let your server follow your AD automatically and update bounded campaign recipients, including already scheduled sending plans.](../../application-reference/settings/common-system-settings/azure-ad-settings.md#importing)
