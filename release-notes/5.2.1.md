...
* [Training Diploma](../application-reference/templates/awareness-training-diploma.md) Download: Resolved an issue where downloaded diplomas were missing file extensions.
* [End User Portal](../application-reference/users/end-user-portal-settings.md) Access: Fixed a bug causing a blank page to appear when accessing the portal via its direct URL.
