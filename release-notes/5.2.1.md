...
* [Training Diploma](../application-screens-reference/templates/awareness-training-diploma.md) Download: Resolved an issue where downloaded diplomas were missing file extensions.
