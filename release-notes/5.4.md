...
* Redesigned [Risk Levels](../application-reference/users/risk-score.md) Page – Set risk thresholds with intuitive sliders and configure up to 10 custom levels.
...
* New [Notification Box](../application-reference/notifications.md#managing-notifications) – A sleek slide-down design showing only unread alerts, with quick actions and a link to all notifications.
* Improved [Campaign Scheduler](../application-reference/campaigns/campaign-settings/optional-settings/schedule/) – Enhanced logic with visual indicators for better timing and control.
