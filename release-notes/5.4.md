...
* Improved [Campaign Scheduler](../application-reference/campaigns/campaign-settings/configuration/schedule/) – Enhanced logic with visual indicators for better timing and control.
