...
* **Recipient Grouping:** Create [recipient groups](../application-reference/users/recipient-groups.md) directly within the [campaign creation wizard](../application-reference/campaigns/wizard-mode/) for a streamlined setup.
