...
* **Recipient Grouping:** Create [recipient groups](../application-reference/users/recipient-groups.md) directly within the [campaign creation wizard](../application-reference/campaigns/new-campaign/wizard-mode/) for a streamlined setup.
