...
User Settings allow you to add an [Administrative User](../../../users/administrative-users.md) with the role of "**User**" to a campaign and set the desired permissions. This is ideal for including stakeholders in the campaign, ensuring they are bound by their respective [client](../../../settings/clients/) for data isolation and are given only the necessary permissions to view or make minor changes to the campaign configuration.

{% hint style="success" %}
Administrative users with "**Access All Campaigns**" will automatically be added to campaigns for their client.
{% endhint %}
