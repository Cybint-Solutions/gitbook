...
Search for an Awareness template, select **Use Template**, and specify the default language.
...
Click the expand button in the top-right corner to view more editing options.
{% endtab %}
...
Navigate to -> [Settings -> Common System Settings -> Mail Settings](awareness-education.md#mail-settings)\
\
