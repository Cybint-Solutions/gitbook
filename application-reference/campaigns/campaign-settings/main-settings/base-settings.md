...
Here you can configure the basic settings of the campaign.

<figure><img src="../../../../.gitbook/assets/image (1020).png" alt=""><figcaption></figcaption></figure>

#### Campaign Name

Give the campaign a descriptive name. This will be visible in the campaign reports.

#### Client

Assign a [client](../../../settings/clients/) to the campaign.
...
This field is used to benchmark the campaign against average values in the selected industry.\
This is optional and local to your workstation. **No data is shared**.
