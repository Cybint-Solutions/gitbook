...
{% hint style="info" %}
[End User](../../../users/end-users/) accounts give your recipients access to a dashboard where they can view their stats and training materials. See [here](../../../users/end-user-portal-settings.md) for a guide on setting up the end user portal.
{% endhint %}
