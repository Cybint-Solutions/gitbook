...
This is your Lucy server's unique identifier. We always require this ID when updating licenses or when you interact with our [Technical Support Department](../../contact-us.md).
...
**Transferring LUCY License Files:** The license file is stored on our centralized server. To move an existing license, [provide us with the new Workstation ID](../../contact-us.md), and we will update it on our licensing server.
...
* No automatic renewal. Contact your Customer Success Manager or connect with our [Technical Support department](../../contact-us.md) to renew your license.
