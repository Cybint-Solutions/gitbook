...
\
If Auto Login was activated and you are locked out of your Lucy server, please reach out to our [technical support department](../../../contact-us.md) for assistance with disabling the Auto Login feature.
{% endhint %}
...
This setting allows seamless login but should be used carefully, as enabling it can restrict alternative access methods. [Contact Lucy support](../../../contact-us.md) if auto login prevents access.
