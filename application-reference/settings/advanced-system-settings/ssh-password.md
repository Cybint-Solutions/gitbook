...
\
**Objective**: Configure inbound SSH access for direct system administration by launching the setup tool ([setup.py](../../../guides/installing-lucy/installing-lucy/#installation-tutorial)).\
\
