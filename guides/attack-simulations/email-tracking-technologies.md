...
Email tracking settings can be adjusted within the [scenario settings of a campaign](../../application-reference/campaigns/campaign-settings/configuration/attack-settings.md#advanced-tracking), allowing for tailored tracking strategies based on campaign goals and the technology's limitations.
