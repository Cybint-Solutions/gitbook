...
Smishing, also known as SMS Phishing, is a deceptive tactic where fraudulent text messages are sent to trick recipients into revealing sensitive information such as credit card details or passwords. It's important to note that this type of attack can only be configured in [**Expert Mode**](../../../../application-reference/campaigns/create-a-campaign/expert-mode.md).
{% endtab %}
